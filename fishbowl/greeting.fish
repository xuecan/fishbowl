...
function fish_greeting
  ...
  printf '\n'
  printf 'Welcome to '(set_color -u)(set_color -o d75f00)'f'(set_color -o ffff00)'i'(set_color -o ff0000)'sh'(set_color normal)
  ...
  printf (set_color -u 5fffff)'fishbowl'(set_color normal)
